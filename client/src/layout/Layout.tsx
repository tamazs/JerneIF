            ...
            <div className="drawer lg:drawer-open">
                ...
                <div className="drawer-content">
                    ...
                    <nav className="navbar w-full bg-primary flex items-center justify-between">
                        ...
                        <div className="px-4">
                            {loggedInUser?.role === "Player" ? <button onClick={() => navigate("/mytransactions")} className="btn btn-secondary text-primary">Balance: {balance} DKK</button> : null}
                        </div>
                    </nav>
                    {/* Page content */}
                ...
                <div className="drawer-side is-drawer-close:overflow-visible">
                    ...
                    <div className="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-14 is-drawer-open:w-64">
                        ...
                        <ul className="flex flex-col h-screen justify-between">
                            {/* List item */}
                            <div className="menu w-full grow gap-2">
                                <li>
                                ...
                                <li>
                                    <button className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Profile" onClick={() => {
                                        ...
                                        <span className="is-drawer-close:hidden">Edit user</span>
                                    </button>
                                </li>
                                <li>
                                    <button className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Log out" onClick={() => jerneCrud.logoutUser()}>
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeWidth="1.5" fill="currentColor" className="size-6">
                            ...
                            <div className="is-drawer-close:hidden menu">
